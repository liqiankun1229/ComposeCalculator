			...
			null !== e.reFun &&
				...
				function(e) {
					...
					var o = navigator.userAgent,
						...
						s = -1 < o.indexOf(a) || !0;
					n && s && (c && console.log("002"),
							window.coreyl.pushFun(JSON.stringify(e))),
						r && s && (c && console.log("003"),
							window.webkit.messageHandlers.core.postMessage(JSON.stringify(e)))
				}({
					funName: e.funName,
				...
				e = function(e, o, n) {
					...
					if (c && console.log("007----------------------\\x3e"),
						...
						if (0 === parseInt(e.errorCode)) {
							...
							c && console.log("010--------------\\x3e"), n[r.reFun].onFail({
								errorCode: e.errorCode,
								errorMsg: e.errorMsg
							})
						} catch (e) {
