...
//        val url = "http://192.168.1.31:8080/Gradle___iMTalker___iMTalker_1_0_war/"
...
//        webView!!.addJavascriptInterface(this, "main")
        ...
        webView!!.addJavascriptInterface(callJS, "lqkCore")
...
//                .show()
    ...
    inner class CustomWebViewClient : WebViewClient() {
        override fun onPageFinished(p0: WebView?, p1: String?) {
            ...
            loadJsFromLocal("index", "custom_index.js")
...
//            webView?.loadUrl("http://192.168.1.31:8080/Gradle___iMTalker___iMTalker_1_0_war/")
            webView?.loadUrl("${Config.BASE_URL}:8081/estateOwner")
        } else {
...
//        webView?.loadUrl("javascript:(function() { $jsStr })()")
        webView?.loadUrl("javascript:coreJSBridge.onWeb('${viewBinding.etAndroid.text.toString()}')")
    }
