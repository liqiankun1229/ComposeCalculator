...
object PackageUtils {
    ...
    fun searchLocalPackage(name: String): VersionInfo? {
        return packagesList.search(name)
    }
...
//            Log.d(LocalPackageActivity.TAG, "downVersion: ${versionInfo.url}")
    ...
    fun useNetworkPackageInfo(l: MutableList<VersionInfo>) {
        packagesList.clear()
        packagesList.addAll(l)
    }
